  ...
  const validateField = (fieldName) => {
    ...
    switch (fieldName) {
      case "Id":
        ...
        } else if (parseInt(value) > 3999999999) {
          updatedErrorMessages[fieldName] =
            "El campo de ID no puede ser mayor a 3.999.999.999.";
        } else {
          updatedErrorMessages[fieldName] = "";
        }
        break;
      case "Nombre":
        const nombrePattern = /^[\p{L}ÁÉÍÓÚáéíóúÑñ\s0-9]+$/u;
            ...
            <div className="modal-body">
              ...
              <div className="input-group mb-3">
                ...
                >
                  ...
                  <option value="buen_estado">Ocupado</option>
                  <option value="mal_estado">Disponible</option>
                </select>
