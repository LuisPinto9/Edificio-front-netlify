...
export const add = async (datos) => {
  try {
    await Axios.post(
      "https://edificio-back-vercel.vercel.app/componentes/create",
      {
        Id: datos.Id,
        Nombre: datos.Nombre,
        Marca: datos.Marca,
...
export const update = async (datos) => {
  try {
    await Axios.put(
      "https://edificio-back-vercel.vercel.app/componentes/update",
      {
        Id: datos.Id,
        Nombre: datos.Nombre,
        Marca: datos.Marca,
...
export const eliminar = async ({ val, getComponentes }) => {
  try {
    ...
    if (result.isConfirmed) {
      ...
      await Axios.delete(`https://edificio-back-vercel.vercel.app/componentes/delete/${val.id}`, {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
      });
...
export const componentes = async () => {
  try {
    const response = await Axios.get(
      "https://edificio-back-vercel.vercel.app/componentes/get-componentes",
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
...
export const buscarComponente = async (nombreBuscar) => {
  try {
    const response = await Axios.get(
      `https://edificio-back-vercel.vercel.app/componentes/find-componente/${nombreBuscar}`,
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
