...
export const add = async (datos) => {
  try {
    await Axios.post(
      "https://edificiokandc-back.onrender.com/componentes/create",
      {
        Id: datos.Id,
        Nombre: datos.Nombre,
        Marca: datos.Marca,
...
export const update = async (datos) => {
  try {
    await Axios.put(
      "https://edificiokandc-back.onrender.com/componentes/update",
      {
        Id: datos.Id,
        Nombre: datos.Nombre,
        Marca: datos.Marca,
...
export const eliminar = async ({ val, getComponentes }) => {
  try {
    ...
    if (result.isConfirmed) {
      ...
      await Axios.delete(`https://edificiokandc-back.onrender.com/componentes/delete/${val.id}`, {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
      });
...
export const componentes = async () => {
  try {
    const response = await Axios.get(
      "https://edificiokandc-back.onrender.com/componentes/get-componentes",
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
...
export const buscarComponente = async (nombreBuscar) => {
  try {
    const response = await Axios.get(
      `https://edificiokandc-back.onrender.com/componentes/find-componente/${nombreBuscar}`,
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
