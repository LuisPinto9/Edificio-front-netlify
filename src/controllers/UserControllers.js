...
export const add = async (datos) => {
  try {
    await Axios.post(
      "https://edificiokandc-back.onrender.com/user/create",
      {
...
export const update = async (datos) => {
  try {
    await Axios.put(
      "https://edificiokandc-back.onrender.com/user/update",
      {
        IDUsuario: datos.IDUsuario,
        Nombre: datos.Nombre,
        MetodoRenta: datos.MetodoRenta,
...
export const eliminar = async ({ val, getArrendatarios }) => {
  try {
    ...
    if (result.isConfirmed) {
      await Axios.delete(`https://edificiokandc-back.onrender.com/user/delete/${val.id}`, {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
      });
...
export const arrendatarios = async () => {
  try {
    const response = await Axios.get("https://edificiokandc-back.onrender.com/user/get-users", {
      headers: {
        Authorization: localStorage.getItem("auth"),
      },
    });
...
export const buscarUsuario = async (idBuscar) => {
  try {
    const response = await Axios.get(
      `https://edificiokandc-back.onrender.com/user/find-users/${idBuscar}`,
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
...
export const buscarUsuarioId = async (idBuscar) => {
  try {
    const response = await Axios.get(
      `https://edificiokandc-back.onrender.com/user/find-user-id/${idBuscar}`,
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
