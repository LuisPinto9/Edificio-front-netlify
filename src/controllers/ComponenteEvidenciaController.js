...
export const addEvidencia = async (datos, file, getComponentesEvidencias) => {
  try {
    await Axios.post(
      "https://edificiokandc-back.onrender.com/componentes-evidencias/create",
...
const addFile = async (file) => {
  try {
    if (file) {
      ...
      await Axios.post("https://edificiokandc-back.onrender.com/file", formData, {
        headers: {
...
export const updateEvidencia = async (
  ...
  try {
    await Axios.put(
      "https://edificiokandc-back.onrender.com/componentes-evidencias/update",
      {
        id: datos.id,
        nombre: datos.nombre,
        descripcion: datos.descripcion,
...
const updateFile = async (file, nombre) => {
  try {
    if (file) {
      ...
      formData.append("image", file);
      await Axios.post(
        `https://edificiokandc-back.onrender.com/update-file/${nombre}`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
...
export const eliminarEvidencia = async ({ val, getComponentesEvidencias }) => {
  try {
    ...
    if (result.isConfirmed) {
      await Axios.delete(
        `https://edificiokandc-back.onrender.com/componentes-evidencias/delete/${val.id}`,
        {
          headers: {
            Authorization: localStorage.getItem("auth"),
          },
...
const deleteFile = async (nombre) => {
  try {
    await Axios.delete(`https://edificiokandc-back.onrender.com/delete-file/${nombre}`);
  } catch (error) {}
};
...
export const componentesEvidencia = async () => {
  try {
    const response = await Axios.get(
      "https://edificiokandc-back.onrender.com/componentes-evidencias/get-evidencias",
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
...
export const buscarEvideciaComponente = async (idBuscar) => {
  try {
    const response = await Axios.get(
      `https://edificiokandc-back.onrender.com/componentes-evidencias/find-evidencias/${idBuscar}`,
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
...
export const getEvidenciaImage = async (nombre) => {
  try {
    const response = await Axios.get(
      `https://edificiokandc-back.onrender.com/get-file/${nombre}`,
      {
