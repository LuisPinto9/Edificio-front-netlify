...
export const add = async (datos) => {
  try {
    await Axios.post(
      "https://edificio-back-vercel.vercel.app/zonas/create",
      {
        Id: datos.Id,
        Nombre: datos.Nombre,
...
export const update = async (datos) => {
  try {
    await Axios.put(
      "https://edificio-back-vercel.vercel.app/zonas/update",
      {
        Id: datos.Id,
        Nombre: datos.Nombre,
        Descripcion: datos.Descripcion,
...
export const eliminar = async ({ val, getZonas }) => {
  try {
    ...
    if (result.isConfirmed) {
      await Axios.delete(`https://edificio-back-vercel.vercel.app/zonas/delete/${val.id}`, {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
      });
...
export const zonas = async () => {
  try {
    const response = await Axios.get("https://edificio-back-vercel.vercel.app/zonas/get-zonas", {
      headers: {
        Authorization: localStorage.getItem("auth"),
      },
    });
...
export const getZonasInicio = async () => {
  try {
    const response = await Axios.get("https://edificio-back-vercel.vercel.app/zonas/get-zonas-inicio");
    return response.data;
  } catch (error) {
    Swal.fire({
      title: "Error al obtener los datos",
...
export const buscarZona = async (idBuscar) => {
  try {
    const response = await Axios.get(
      `https://edificio-back-vercel.vercel.app/zonas/find-zona/${idBuscar}`,
      {
        headers: {
          Authorization: localStorage.getItem("auth"),
        },
